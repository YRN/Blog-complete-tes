                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                ...
                                <h2 class="post__title entry-title text-center">
                                    <a
                                        href="{{ route('post.single',['slug' => $first_post->slug])}}">{{$first_post->title}}</a>
                                </h2>
                    ...
                    <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                ...
                                <h2 class="post__title entry-title text-center">
                                    <a
                                        href="{{ route('post.single',['slug' => $second_post->slug])}}">{{$second_post->title}}</a>
                                </h2>
                                ...
                                <div class="post-additional-info">
                                    ...
                                    <span class="category">
                                        <i class="seoicon-tags"></i>
                                        <a
                                            href="{{ route('category.single',['id' => $second_post->category->id])}}">{{$second_post->category->name}}</a>
                                    </span>
                    ...
                    <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                ...
                                <h2 class="post__title entry-title text-center">
                                    <a
                                        href="{{ route('post.single',['slug' => $third_post->slug])}}">{{$third_post->title}}</a>
                                </h2>
                                ...
                                <div class="post-additional-info">
                                    ...
                                    <span class="category">
                                        <i class="seoicon-tags"></i>
                                        <a
                                            href="{{ route('category.single',['id' => $third_post->category->id])}}">{{$third_post->category->name}}</a>
                                    </span>
